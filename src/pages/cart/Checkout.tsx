        ...
        <>
            ...
            <main className="lg:flex lg:min-h-full lg:flex-row-reverse lg:overflow-hidden">
                ...
                <section
                    ...
                    className="flex items-center justify-between bg-beige-50 px-4 py-6 sm:px-6 lg:hidden"
                >
                                ...
                                <Disclosure.Panel>
                                        ...
                                        {products.map((product) => (
                                            <li key={product.id} className="flex space-x-6 py-6">
                                                <Image
                                                    ...
                                                    className="h-40 w-40 flex-none rounded-md bg-beige-200 object-cover object-center"
                                                />
                                    ...
                                    <form className="mt-10">
                                        <label
                                            ...
                                            className="block text-sm font-medium text-beige-700"
                                        >
                                            Codice sconto
                                        </label>
                                    ...
                                    <dl className="mt-10 space-y-6 text-sm font-medium text-beige-500">
                                        ...
                                        <div className="flex justify-between">
                                            <dt className="flex">
                                                Sconto
                                                <span className="ml-2 rounded-full bg-beige-200 py-0.5 px-2 text-xs tracking-wide text-beige-600">
                                                    {discount.code}
                                                </span>
                                            </dt>
                ...
                <section
                    ...
                    className="hidden w-full max-w-min flex-col bg-beige-50 lg:flex"
                >
                    ...
                    <div className="sticky bottom-0 flex-none border-t  bg-beige-50 p-6">
                        ...
                        <dl className="mt-10 space-y-6 text-sm font-medium text-beige-500">
                            ...
                            <div className="flex justify-between">
                                <dt className="flex">
                                    Sconto
                                    <span className="rounded-sm1 ml-2 bg-beige-200 py-0.5 px-2 text-xs tracking-wide text-beige-600">
                                        {discount.code}
                                    </span>
                                </dt>
                                <dd className="text-beige-900">-{discount.amount} €</dd>
                    ...
                    <div className="mx-auto mt-8 max-w-lg">
                        ...
                        <form className="mt-6">
                            <div className="grid grid-cols-12 gap-y-6 gap-x-4">
                                ...
                                <div className="col-span-8 sm:col-span-9">
                                    <label
                                        ...
                                        className="block text-sm font-medium text-beige-900"
                                    >
                            ...
                            <p className="mt-6 flex justify-center text-sm font-medium text-beige-900">
                                <LockClosedIcon className="mr-1.5 h-5 w-5 text-beige-900" aria-hidden="true" />I
