...
//     const notify = (products: Products) => {
//         toast.success(
//             <div key={products.id}>
...
//                                                     <Image className="h-full w-full rounded-lg object-cover object-center shadow-xl" src={p.image.url} alt={'not found'} />
//                                                 </span>
//                                                 <span
...
//                             {products.map((p) => (
//                                 <Tab.Panel key={p.image.id}>
//                                     <Image className="h-min w-min rounded-lg border-4 border-beige-600 object-cover object-center shadow-xl " src={p.image.url} alt={'not found'} />
//                                 </Tab.Panel>
//                             ))}
//                         </Tab.Panels>
//                     </Tab.Group>
...
//                             <Link href={`/Prodotti/${productsConsigliati.id}`} key={productsConsigliati.id}>
...
//     try {
//         const resRelated: AxiosResponse = await axios.get(`/api/variantetaglias?populate=*&filters[slug][$eq]=${ctx.params.id}`)
...
//             props: { productsData: resRelated.data, productsConsigliati: resRelated.data, revalidate: 1 }, // Next.js will attempt to re-generate the page, When a request comes in,At most once every second
//         }
//     } catch (err) {
