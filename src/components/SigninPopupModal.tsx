                ...
                <div className="min-h-screen text-center">
                    ...
                    >
                        <div className="relative my-8 inline-block w-full max-w-xl transform overflow-hidden bg-neutral text-left shadow-2xl transition-all sm:rounded-xl">
                            <button onClick={closeModal} className="absolute top-2 right-2 shrink-0 rounded-md p-1 transition hover:bg-gray-100 focus:outline-none">
                            ...
                            <div className="py-12">
                                <div className="px-4 sm:px-12">
                                    ...
                                    {!showSignIn ? (
                                        <Dialog.Description className="mt-2 text-center text-base text-gray-500">This feature will be implemented in next series of article.</Dialog.Description>
                                    ) : null}
                                </div>
                            </div>
                        </div>
